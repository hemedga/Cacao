<# Script source https://support.google.com/a/answer/9250996?hl=en#scriptlet #>
<# Downloaded on 22/10/2020 #>
<# Maintainer: Hemi Gur-Ary#>

<# Change tracking:
$domainsAllowedToLogin = "phoenix-dx.com,phoenix.services,polarys.tech"
...
$domainsAllowedToLogin = "phoenix-dx.com,vata.net.au"
